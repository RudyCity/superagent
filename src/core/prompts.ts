...
# WORKFLOW
1. SKILL CHECK: Call get_skills tool to search/list skills. Call use_skill tool with the name or path of relevant skills to load and follow their instructions. Pass skill names/paths to Subagents.
...
${BATCH_OPS_RULE}
${FAST_ANALYSIS_RULE}
- SKILL CHECK: Call get_skills tool to search/list skills. Call use_skill tool with the name or path of relevant skills to load and follow their instructions. Follow workflow.
${CONTEXT_ANCHOR_RULE}
