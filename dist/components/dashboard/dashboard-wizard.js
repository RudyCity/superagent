...
export function DashboardWizard({ activeWizard, query, wizardAllOptions, wizardSelectedIndex, wizardIsLoadingModels, wizardOptions, wizardSelectedSet, pendingQuestion, agent, terminalWidth, focus, scrollOffset, onScrollChange, }) {
    if (!activeWizard) {
        return null;
    }
    const wizardBorderColor = "cyan";
    return (_jsxs(Box, { flexDirection: "column", paddingX: 1, marginY: 0, width: "100%", children: [_jsx(Box, { flexDirection: "row", marginTop: 0, children: _jsx(Text, { color: wizardBorderColor, children: "\u2502" }) }), activeWizard.type === "model" && (activeWizard.step === 15 || activeWizard.step === 24 || activeWizard.step === 34) && (() => {
                const lc = query.trim();
                ...
                return (_jsx(WizardDialog, { title: searchTitle, borderColor: wizardBorderColor, options: filteredModels.length > 0 ? filteredModels : ["(no results — try different search)"], selectedIndex: clampedIndex, maxVisible: 8, marginY: 0, isLoading: wizardIsLoadingModels, terminalWidth: terminalWidth }));
            })(), activeWizard.type === "plan_approve" && (_jsx(_Fragment, { children: _jsx(PlanApprovalDialog, { planFilePath: agent ? path.resolve(agent.getPlanFilePath()) : "", selectedIndex: wizardSelectedIndex, step: activeWizard.step, borderColor: "yellow", terminalWidth: terminalWidth, maxContentHeight: 10, focus: focus, scrollOffset: scrollOffset, onScrollChange: onScrollChange }) })), (activeWizard.type !== "model" || (activeWizard.step !== 15 && activeWizard.step !== 24 && activeWizard.step !== 34)) && activeWizard.type !== "plan_approve" && (_jsxs(Box, { flexDirection: "column", children: [activeWizard.type === "question" && activeWizard.questions && activeWizard.currentQuestionIndex !== undefined && (_jsx(Box, { flexDirection: "row", flexWrap: "wrap", marginBottom: 1, children: activeWizard.questions.map((q, idx) => {
                            const num = idx + 1;
                            ...
                            if (isPassed) {
                                ...
                                return (_jsx(Box, { marginRight: 2, children: _jsxs(Text, { color: "green", dimColor: true, children: ["[\u2714 ", num, ". ", label, displayAns, "]"] }) }, idx));
                            }
                            else if (isActive) {
                                return (_jsx(Box, { marginRight: 2, children: _jsxs(Text, { color: "cyan", bold: true, children: ["\u276F ", num, ". ", label] }) }, idx));
                            }
                            else {
                                return (_jsx(Box, { marginRight: 2, children: _jsxs(Text, { color: "gray", dimColor: true, children: ["(", num, ". ", label, ")"] }) }, idx));
                            }
                        }) })), _jsx(WizardDialog, { title: activeWizard.type === "model" && activeWizard.step === 1 ? `⚙️ SELECT AGENT TIER TO CONFIGURE:` :
                                                                                                            ...
                                                                                                            activeWizard.type === "skills" ? `🛠️ SKILLS MANAGER (Step ${activeWizard.step}):` :
                                                                                                                activeWizard.type === "checkpoint" ? `📋 CHECKPOINT MANAGER (Step ${activeWizard.step}):` :
                                                                                                                    activeWizard.type === "plan_approve" ? `⚠️ PLAN APPROVAL REQUIRED (Use Arrow Keys Up/Down & Enter):` :
                                                                                                                        activeWizard.type === "question" ? (activeWizard.step === 2
                                                                                                                                                                    ...
                                                                                                                                                                    activeWizard.type === "login" && activeWizard.step === 11 ? "🛠️ PROJECT INITIALIZATION — Enter Project Name (Type & Enter, Esc: Back):" :
                                                                                                                                                                        activeWizard.type === "login" && activeWizard.step === 12 ? "🛠️ PROJECT INITIALIZATION — Enter Project Description (Type & Enter, Esc: Back):" :
                                                                                                                                                                            activeWizard.type === "login" && activeWizard.step === 13 ? "🤖 AI PROJECT INITIALIZATION — Describe Project Goal (Type & Enter, Esc: Back):" :
                                                                                                                                                                                `🔑 PROVIDER CREDENTIALS (Step ${activeWizard.step}):`, description: activeWizard.type === "plan_approve" ? `AI model has designed a plan in file: file:///${path.resolve(agent.getPlanFilePath()).replace(/\\/g, "/")}` :
                                                                                            ...
                                                                                            activeWizard.type === "login" && activeWizard.step === 11 ? "Specify the name for this workspace:" :
                                                                                                activeWizard.type === "login" && activeWizard.step === 12 ? "Give a one-sentence overview description of this software:" :
                                                                                                    activeWizard.type === "login" && activeWizard.step === 13 ? "State what you want to build (e.g. 'A command-line text editor in Rust'). AI will construct agents.md specs:" :
                                                                                                        undefined, borderColor: wizardBorderColor, options: wizardOptions, selectedIndex: wizardSelectedIndex, maxVisible: 10, isMultiSelect: activeWizard.isMultiSelect, selectedSet: wizardSelectedSet, marginY: 0, terminalWidth: terminalWidth, isLoading: wizardIsLoadingModels })] })), _jsx(Box, { flexDirection: "row", marginTop: 0, children: _jsx(Text, { color: wizardBorderColor, children: "\u2502" }) })] }));
}
//# sourceMappingURL=dashboard-wizard.js.map