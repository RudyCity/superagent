...
export function TaskChecklist({ planState, checklistTasks, checklistScrollOffset, maxChecklistVisible, focusMode, isMultiAgent, completedHistory = [], }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", paddingX: 1, children: [hasActiveTasks && (_jsxs(_Fragment, { children: [_jsx(Box, { flexDirection: "row", justifyContent: "space-between", children: _jsxs(Text, { bold: true, color: focusMode === "checklist" ? "green" : "cyan", children: ["\uD83D\uDCCB ACTIVE TASK CHECKLIST (", completedTasks, "/", totalTasks, " completed)", scrollIndicator, helpText] }) }), visibleChecklist.map((task, index) => {
