...
export function TaskChecklist({ planState, checklistTasks, checklistScrollOffset, maxChecklistVisible, focusMode, isMultiAgent, completedHistory = [], maxHistoryVisible = 3, }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", children: [hasActiveTasks && (_jsxs(_Fragment, { children: [_jsx(Box, { flexDirection: "row", justifyContent: "space-between", children: _jsxs(Text, { bold: true, color: focusMode === "checklist" ? "green" : "cyan", children: ["\uD83D\uDCCB ACTIVE TASK CHECKLIST (", completedTasks, "/", totalTasks, " completed)", scrollIndicator, helpText] }) }), visibleChecklist.map((task, index) => {
                        ...
                        return (_jsxs(Box, { flexDirection: "row", children: [_jsxs(Text, { color: connectorColor, children: [connector, " "] }), _jsxs(Text, { color: connectorColor, children: [statusIcon, " "] }), _jsxs(Text, { color: taskColor, strikethrough: isCompleted, children: [task.text, displayStatusText] })] }, idx));
                    })] })), hasHistory && (_jsxs(_Fragment, { children: [_jsx(Box, { flexDirection: "row", marginBottom: 0, children: _jsxs(Text, { bold: true, color: "gray", dimColor: true, children: ["\u2713 PREVIOUSLY COMPLETED (", completedHistory.length, " tasks)", headerTimeText] }) }), hiddenHistoryCount > 0 && (_jsx(Box, { flexDirection: "row", children: _jsxs(Text, { color: "gray", dimColor: true, children: ["  ", "\u2026 +", hiddenHistoryCount, " more in history"] }) })), historyToShow.map((task, index) => {
                        const connector = "├──";
                        return (_jsxs(Box, { flexDirection: "row", children: [_jsxs(Text, { color: "gray", dimColor: true, children: [connector, " "] }), _jsx(Text, { color: "gray", dimColor: true, children: "\u25C9 " }), _jsx(Text, { color: "gray", dimColor: true, strikethrough: true, children: task.text })] }, `hist-${index}`));
                    })] }))] }));
}
//# sourceMappingURL=task-checklist.js.map