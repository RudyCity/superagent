 ...
 */
const toolCallSupportCache = new Map();
export async function probeToolCallSupport(baseUrl, apiKey, model) {
...
export function clearToolCallSupportCache() {
 ...
 *   </tool_calls>
 */
export function buildToolsSystemPromptBlock(tools) {
    if (!tools.length)
        return "";
    const xmlDefs = tools
        .map((t) => {
...
//# sourceMappingURL=promptBasedToolCalling.js.map