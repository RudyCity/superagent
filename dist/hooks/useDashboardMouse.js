...
export function useDashboardMouse(ctx) {
    const { wrappedLines, logsCount, terminalSize, activeWizard, setActiveWizard, wizardOptions, wizardSelectedIndex, setWizardSelectedIndex, wizardSelectedSet, setWizardSelectedSet, setWizardOptions, pendingQuestion, handleWizardSubmit, query, setQuery, wizardAllOptions, workspaceHeight, leftTopHeight, wizardIsLoadingModels, agent, focusArea, setFocusArea, setLogScrollOffset, setChecklistScrollOffset, setAgentsScrollOffset, setProcsScrollOffset, checklistTasksCount, maxChecklistVisible, agentsCount, maxAgentsVisible, procsCount, maxProcsVisible, } = ctx;
    useEffect(() => {
...
//# sourceMappingURL=useDashboardMouse.js.map