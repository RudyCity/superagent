...
import fs from "fs";
import { checkPlanStructure } from "../core/agent.js";
// Import sub-wizards
...
export function useWizardSubmit(ctx) {
    const { activeWizard, setActiveWizard, wizardOptions, setWizardOptions, wizardSelectedIndex, setWizardSelectedIndex, setWizardSelectedSet, addLine, setInput, setIsProcessing, setPlanState, agentRef, pendingQuestion, setPendingQuestion, planState, streamBufferRef, setStreamDisplay, exit, } = ctx;
