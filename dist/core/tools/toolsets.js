...
import { askQuestionTool, scheduleTool, gitActionTool, screenshotTool, androidCliTool, searchHistoryTool, gitWorktreeTool, manageTasksTool, listPeerSuperagentsTool, managePlanTool, } from "./otherTools.js";
...
export const superagentToolset = [
    readTool,
    writeToFileTool,
...
export const defaultSubagentToolset = [
    readTool,
    globTool,
    grepTool,
    fastcontextTool, // AI-powered repo explorer
