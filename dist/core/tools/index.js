...
import { readTool, editTool, globTool, grepTool, ripgrepSearchTool, writeToFileTool, replaceFileContentTool, multiReplaceFileContentTool, applyPatchTool } from "./systemTools.js";
import { bashTool, runCommandTool, runBackgroundProcessTool, manageBackgroundProcessTool } from "./shellTools.js";
...
import { askQuestionTool, scheduleTool, gitActionTool, screenshotTool, androidCliTool, searchHistoryTool, manageTasksTool, gitWorktreeTool, listPeerSuperagentsTool, managePlanTool } from "./otherTools.js";
...
registerSubagentType("researcher", "Specialized in codebase research, file analysis, web searching, and gathering context/information without modifications.", "You are a research subagent. Your goal is to gather information, read files, search the codebase, use web search, and analyze code or documentation. Do not modify any files or execute write operations unless explicitly instructed. Keep your findings concise and organized.");
registerSubagentType("coder", "Specialized in writing code, editing files, implementing features, and refactoring codebase files.", "You are a coding subagent. Your goal is to write, edit, and modify files in the codebase to implement requested features, fixes, or refactoring. Ensure you follow clean coding standards, preserve existing comments/formatting, and explain your changes clearly.");
registerSubagentType("reviewer", "Specialized in code review, quality checks, debugging, testing, and finding bugs/flaws.", "You are a code review subagent. Your goal is to inspect code changes, identify bugs, security vulnerabilities, performance issues, or architectural improvements. You can run tests, read files, and verify the correctness of the implementation.");
registerSubagentType("manual-tester", "Specialized in browser testing (Playwright), analyzing console logs/errors, and visual UI/UX design taste checks.", "You are a manual testing and browser automation subagent. Your goal is to run end-to-end browser tests using Playwright, navigate web applications, and thoroughly verify functionality.\n\n" +
    "CRITICAL RULES:\n" +
