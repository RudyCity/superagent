 ...
 */
export async function createCheckpoint(sessionFilePath, name, messages, planState, workingDirectory) {
    ...
    let planFileContent;
    let taskFileContent;
    let taskHistoryFileContent;
    let walkthroughFileContent;
    try {
 ...
 */
export async function listCheckpointsForSession(sessionFilePath) {
    const checkpointsDir = path.join(path.dirname(sessionFilePath), "checkpoints");
 ...
 */
export async function restoreCheckpoint(checkpointFilePath, sessionFilePath) {
 ...
 */
export async function deleteCheckpointsForSession(sessionFilePath) {
 ...
 */
export function terminateActiveTasksAndSubagents() {
 ...
 */
export async function restoreCheckpointById(id, sessionFilePath) {
 ...
 */
export async function deleteCheckpointById(id, sessionFilePath) {
    const checkpoints = await listCheckpointsForSession(sessionFilePath);
    const found = checkpoints.find((c) => c.id === id);
    if (!found)
        return false;
