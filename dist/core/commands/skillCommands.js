...
export const installCommand = {
    ...
    async execute(args, ctx) {
        ...
        if (ctx.agent) {
            ...
            try {
                await ctx.agent.sendMessage(`I would like you to install the skill: "${args}". Please execute the command "npx skills add ${args}" using your terminal execution tools. If there are any interactive prompts or registration required, handle them automatically. Once complete, verify the installation and let me know.`);
            }
            catch (err) {
                ctx.addLine({
                    type: "error",
...
//# sourceMappingURL=skillCommands.js.map