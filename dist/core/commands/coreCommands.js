...
import { allTools, superagentInstances, subagentInstances, notifySuperagentsChanged, notifySubagentsChanged, setHistoricalSuperagentTokens, backgroundTasks, clearActiveToolOutput, scheduledJobs, killProcessTree, } from "../tools.js";
// /new command
    ...
    execute(args, ctx) {
        ctx.addLine({
            ...
            content: [
                ...
                "              Usage: /pin [index|last|unpin <idx>|list]",
