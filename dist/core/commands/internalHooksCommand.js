...
`;
        ...
        if (subCommand === "active") {
            ...
            try {
                ...
                const answer = await handler("Select which internal hooks you want to activate (Space to check/uncheck, Enter to submit):", options, true, initialCheckedIndices);
...
//# sourceMappingURL=internalHooksCommand.js.map